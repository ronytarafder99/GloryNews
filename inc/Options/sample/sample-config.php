...
$opt_name = apply_filters('wesoftpress/opt_name', $opt_name);
...
Redux::setSection($opt_name, array(
    ...
    'fields'           => array(
        array(
            ...
            'desc'     => __('Demo: https://web.facebook.com/ronytarafder99/', 'redux-framework-demo'),
            'default'  => '#',
        ),
        array(
            'id'       => 'twitter',
...
Redux::setSection($opt_name, array(
    ...
    'id'     => 'home_page',
    'desc'   => __('All Setting For Hime Page, visit: ', 'redux-framework-demo') . '<a href="https://themes.wesoftpress.com/" target="_blank">Theme Doc</a>',
    'icon'   => 'el el-font',
    'fields' => array(
        array(
            'id'       => 'home_cat_0',
...
Redux::setSection($opt_name, array(
    ...
    'id'     => 'typography',
    'desc'   => __('For full documentation on this field, visit: ', 'redux-framework-demo') . '<a href="https://themes.wesoftpress.com/" target="_blank">Theme Doc</a>',
    'icon'   => 'el el-font',
    'fields' => array(
        array(
...
Redux::setSection($opt_name, array(
    ...
    'id'    => 'advertisements',
    'desc'  => 'Paste Ads Code in the Text Section',
    'icon'  => 'el el-list-alt',
    'fields'     => array(
        array(
...
Redux::setSection($opt_name, array(
    ...
    'id'    => 'select',
    'desc'       => __('For full documentation on this field, visit: ', 'redux-framework-demo') . '<a href="https://themes.wesoftpress.com/" target="_blank">Visit Our Blog Page</a>',
    'icon'  => 'el el-list-alt',
));
// support
Redux::setSection($opt_name, array(
    ...
    'id'    => 'support',
    'desc'       => __('If you need help about this theme, You can call: 01889363531</br> Facebook: ', 'redux-framework-demo') . '<a href="https://web.facebook.com/ronytarafder99/" target="_blank">  facebook</a>',
