...
<div id="map" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
    <div class="home_menu_inner map_inner_block">
        <div class="home_menu_online">
            <h2 class="catTitle"><?php echo ($wesoftpress['map_title']); ?><span class="liner"></span></h2>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="map_inner">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background:new -201 -372.5 560 776.5;"
            xml:space="preserve">
            <g id="border">
                <g id="shadow">
                    <path
            ...
            <g id="rangpur">
                <a href="<?php echo $wesoftpress['rangpur']; ?>" xlink:href="<?php echo $wesoftpress['rangpur']; ?>">
            ...
            <g id="sylhet">
                <a href="<?php echo $wesoftpress['sylhet']; ?>" xlink:href="<?php echo $wesoftpress['sylhet']; ?>">
            ...
            <g id="khulna">
                <a href="<?php echo $wesoftpress['khulna']; ?>" xlink:href="<?php echo $wesoftpress['khulna']; ?>">
                    <path class="st3"
            ...
            <g id="dhaka">
                <a href="<?php echo $wesoftpress['dhaka']; ?>" xlink:href="<?php echo $wesoftpress['dhaka']; ?>">
                    <path class="st3"
            ...
            <g id="mymensingh">
                <a href="<?php echo $wesoftpress['mymensingh']; ?>"
                    xlink:href="<?php echo $wesoftpress['mymensingh']; ?>">
                    <path class="st3"
            ...
            <g id="rajshahi">
                <a href="<?php echo $wesoftpress['rajshahi']; ?>" xlink:href="<?php echo $wesoftpress['rajshahi']; ?>">
                    <path class="st14"
            ...
            <g id="borishal">
                <a href="<?php echo $wesoftpress['borishal']; ?>" xlink:href="<?php echo $wesoftpress['borishal']; ?>">
                    <path class="st13"
            ...
            <g id="chittagong">
                <a href="<?php echo $wesoftpress['chittagong']; ?>"
                    xlink:href="<?php echo $wesoftpress['chittagong']; ?>">
        ...
        <form>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    <select class="form-control" name="bd_division" id="division">
                        ...
                        <option value="<?php echo $division->term_id; ?>"
                            data-val="<?php echo get_term_link($division->term_id); ?>"><?php echo $division->name; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    <select class="form-control" name="bd_district" id="district">
                        ...
                        <?php foreach ($districts as $district) {
                            ?>
                        <option value="<?php echo $district->term_id; ?>" style="display:none"
                            class="dist-<?php echo $term->term_id; ?>"
                            data-val="<?php echo get_term_link($district->term_id); ?>"><?php echo $district->name; ?>
                        </option>
                        <?php  } ?>
            ...
            <div class="form-group row px-2">
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    <select class="form-control" name="bd_thana" id="upozilla">
                        ...
                        <?php foreach ($upozilas as $upozila) :  // Level One 
                                ?>
                        <option id="upo" value="<?php echo get_term_link($upozila->term_id); ?>" style="display:none"
                            class="thana-<?php echo $district->term_id; ?>"
                            data-val="<?php echo get_term_link($upozila->term_id); ?>"><?php echo $upozila->name; ?>
                        </option>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="btn btn-danger dist_news_srch w-100"><?php if ($wesoftpress['time-switch'] == '1') {
                                echo 'অনুসন্ধান করুন';
                            } else {
                                echo 'Search';
                            } ?> </div>
