...
<!-- <link type="text/css" href="<?php echo get_template_directory_uri(); ?>/inc/bootstrap.css" rel="stylesheet"> -->
<div id="map" class="col pt-2 pt-sm-2 pt-md-0 pt-lg-3 pt-xl-3">
    <div class="home_menu_inner map_inner_block">
        <div class="home_menu_online">
            <h2 class="catTitle"><?php echo ($redux_demo['map_title']); ?><span class="liner"></span></h2>
        </div>
    ...
    <div class="map_inner">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background:new -201 -372.5 560 776.5;" xml:space="preserve">
            ...
            <g id="rangpur">
                <a href="<?php echo $redux_demo['rangpur']; ?>" xlink:href="<?php echo $redux_demo['rangpur']; ?>">
            ...
            <g id="sylhet">
                <a href="<?php echo $redux_demo['sylhet']; ?>" xlink:href="<?php echo $redux_demo['sylhet']; ?>">
            ...
            <g id="khulna">
                <a href="<?php echo $redux_demo['khulna']; ?>" xlink:href="<?php echo $redux_demo['khulna']; ?>">
            ...
            <g id="dhaka">
                <a href="<?php echo $redux_demo['dhaka']; ?>" xlink:href="<?php echo $redux_demo['dhaka']; ?>">
            ...
            <g id="mymensingh">
                <a href="<?php echo $redux_demo['mymensingh']; ?>" xlink:href="<?php echo $redux_demo['mymensingh']; ?>">
            ...
            <g id="rajshahi">
                <a href="<?php echo $redux_demo['rajshahi']; ?>" xlink:href="<?php echo $redux_demo['rajshahi']; ?>">
            ...
            <g id="borishal">
                <a href="<?php echo $redux_demo['borishal']; ?>" xlink:href="<?php echo $redux_demo['borishal']; ?>">
            ...
            <g id="chittagong">
                <a href="<?php echo $redux_demo['chittagong']; ?>" xlink:href="<?php echo $redux_demo['chittagong']; ?>">
        ...
        <form>
            ...
            <div class="form-group row">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="btn btn-danger dist_news_srch w-100">অনুসন্ধান করুন</div>
                </div>
            </div>
        </form>
    </div>
