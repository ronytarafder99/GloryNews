    ...
    <div class="home_page_part_one_bg">
        <div class="custom_container home_page_part_one">
            <div class="home_page_part_one_left">
                <div class="breadcrumb" style="align-items: center; font-size: 1.1rem;">
                    <li><a href="<?php bloginfo('url'); ?>"><i class="fa fa-home text-danger"></i></a></li> <?php echo "<b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>"; ?>
                    <?php $rlcat = get_queried_object();
                    $rlid = $rlcat->term_id;
                    $parents = get_ancestors($rlid, 'location');
                    foreach (array_reverse($parents) as $term_id) { ?>
                        <li><a href="<?php echo get_term_link($term_id) ?>"><?php echo get_term_by('id', $term_id, 'location')->name; ?></a></li><?php echo "<b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>"; ?>
                    <?php } ?>
